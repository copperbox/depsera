        ...
        <aside className={`${styles.sidebar} ${sidebarOpen ? styles.sidebarOpen : ''} ${sidebarCollapsed ? styles.sidebarCollapsed : ''}`}>
          ...
          <nav className={styles.nav}>
            ...
            >
              ...
              <span className={styles.navLinkText}>Catalog</span>
            </NavLink>
            {isAdmin && (
              <>
                <div className={styles.navDivider}>
                  <span className={styles.navDividerText}>Admin</span>
                </div>
                <NavLink
                ...
                >
                  ...
                  <span className={styles.navLinkText}>Associations</span>
                </NavLink>
                <NavLink
                  to="/admin/users"
                  className={({ isActive }) =>
                ...
                >
                  ...
                  <span className={styles.navLinkText}>Manifests</span>
                </NavLink>
                <NavLink
                  to="/admin/otlp"
                  className={({ isActive }) =>
                ...
                >
                  ...
                  <span className={styles.navLinkText}>OTLP</span>
                </NavLink>
              </>
            )}
          </nav>
